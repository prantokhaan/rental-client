                ...
                <div className="car p-2 bs1">
                  ...
                  <div className="car-content align-items-center justify-content-between">
                    <div className="text-center pl-2">
                      <h3 className="fw-bold" style={{ color: "orangered", textTransform: 'capitalize' }}>
                        {truck.name}
                      </h3>
                      <p className='mb-2'>
                        {" "}
                        Rent Per Day: <span className='fw-bold' style={{color: 'orangered', fontSize: '18px'}}>{truck.rentPerHour}৳</span>
                      </p>
                    </div>
